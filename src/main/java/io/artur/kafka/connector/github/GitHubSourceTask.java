...
import io.artur.kafka.connector.github.model.Issue;
import io.artur.kafka.connector.github.model.PullRequest;
import io.artur.kafka.connector.github.model.User;
import io.artur.kafka.connector.github.utils.DateUtils;
...
public class GitHubSourceTask extends SourceTask {
  ...
  private Map<String, String> sourcePartition() {
    ...
    map.put(REPOSITORY_FIELD, config.getRepo());
    return map;
  }
